...
export const BottomNavBar: React.FC<BottomNavBarProps> = ({
  ...
  return (
    <>
      ...
      {/* Floating Quick New Entry Action Button. Rendered as a sibling of the
          nav so it sits above the tab bar instead of on top of a tab. */}
      <button
        id="quick-new-entry-btn"
        onClick={handleNewEntryClick}
        title="Write New Journal Entry"
        className="aura-fab z-50 w-12 h-12 rounded-full bg-gradient-to-tr from-[#4f46e5] to-[#4fdbc8] text-white shadow-lg shadow-teal-500/20 hover:scale-105 active:scale-95 transition-all duration-200 flex items-center justify-center border border-white/20"
      >
